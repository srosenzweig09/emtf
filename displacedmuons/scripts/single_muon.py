...
gen_pt      = ak.flatten(table1['gen_pt'] )
gen_phi     = ak.flatten(table1['gen_phi'])
gen_eta     = ak.flatten(table1['gen_eta'])
gen_phiStar = ak.flatten(table1['gen_phiStar'])
gen_etaStar = ak.flatten(table1['gen_etaStar'])
gen_q       = ak.flatten(table1['gen_q']  )
gen_d0      = ak.flatten(table1['gen_d0']  )
gen_vz      = ak.flatten(table1['gen_vz']  )

matched_gen_pt      = ak.flatten(table1['matched_gen_pt'] )
matched_gen_phi     = ak.flatten(table1['matched_gen_phi'])
matched_gen_eta     = ak.flatten(table1['matched_gen_eta'])
matched_gen_phiStar = ak.flatten(table1['matched_gen_phiStar'])
matched_gen_etaStar = ak.flatten(table1['matched_gen_etaStar'])
matched_gen_q       = ak.flatten(table1['matched_gen_q']  )
matched_gen_d0      = ak.flatten(table1['matched_gen_d0']  )
matched_gen_vz      = ak.flatten(table1['matched_gen_vz']  )
...
BDT_pt = ak.flatten(table1['emtfTrack_pt'])
NN_pt  = ak.flatten(table1['emtfTrack_pt_dxy'])
NN_d0  = ak.flatten(table1['emtfTrack_dxy'])
